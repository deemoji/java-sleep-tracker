...
public class GetMaximumSessionCommandTest {

    private final GetMaximumSessionCommand sut = new GetMaximumSessionCommand();
    ...
    @Test
    public void shouldReturnMaxDurationWhenMultipleSessions() {
        sessions = List.of(
        ...
        assertEquals(10L * 60L, result.getValue());
    }
